    ...
    return (
      <div id='leitbild' className='page leitbild'>
        ...
        <div className='row marketing'>
          ...
          <div className='col-lg-4'>
            <div className='glyphicon glyphicon-retweet' style={{fontSize: 40 + 'px'}}/>
            <h4>Sinn suchen</h4>
            <p>Menschen gewöhnen sich erstaunlich gut an Inkonsistenzen. Oft leidet darunter die Produktivität.</p>
          ...
          <div className='col-lg-4'>
            <div className='glyphicon glyphicon-screenshot' style={{fontSize: 40 + 'px'}}/>
            <h4>Geeignete Technologie wählen</h4>
            <p>Wer einen Hammer hat, ist verleitet, in allem einen Nagel zu erkennen.</p>
